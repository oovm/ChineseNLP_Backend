...
public class HanLP
{
    ...
    public static final class Config
    {
         ...
         * 简繁转换词典根目录
         */
        public static String tcDictionaryRoot = "dictionary/tc/";
         ...
         * 字符类型对应表
         */
        public static String CharTypePath = "dictionary/other/CharType.bin";

        /**
         * 字符正规化表（全角转半角，繁体转简体）
         */
        public static String CharTablePath = "dictionary/other/CharTable.txt";

        /**
         * 词性标注集描述表，用来进行中英映射（对于Nature词性，可直接参考Nature.java中的注释）
         */
        public static String PartOfSpeechTagDictionary = "dictionary/other/TagPKU98.csv";
         ...
         * CRF分词模型
         */
        public static String CRFCWSModelPath = "model/crf/pku199801/cws.txt";
        /**
         * CRF词性标注模型
         */
        public static String CRFPOSModelPath = "model/crf/pku199801/pos.txt";
        /**
         * CRF命名实体识别模型
         */
        public static String CRFNERModelPath = "model/crf/pku199801/ner.txt";
        /**
         * 感知机分词模型
         */
        public static String PerceptronCWSModelPath = "model/perceptron/large/cws.bin";
        /**
         * 感知机词性标注模型
         */
        public static String PerceptronPOSModelPath = "model/perceptron/pku199801/pos.bin";
        /**
         * 感知机命名实体识别模型
         */
        public static String PerceptronNERModelPath = "model/perceptron/pku199801/ner.bin";
        /**
         * 分词结果是否展示词性
         */
        ...
        static
        {
            ...
            {
                if (new File("dictionary/CoreNatureDictionary.tr.txt").isFile())
                {
